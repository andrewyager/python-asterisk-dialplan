...
class rangeChunks(unittest.TestCase):
    chunks = (
        ...
        (
            ...
            [(61212349993, 61212349999), (61212350000, 61212350002)],
        ),
        # small rollover with only middle and high ranges
        (
            (61212349990, 61212350002),
            [(61212349990, 61212349999), (61212350000, 61212350002)],
        ),
        # tiny small range
        ((61290370463, 61290370469), [(61290370463, 61290370469)]),
        # equal start and end numbers
        ((61290370463, 61290370463), [(61290370463, 61290370463)]),
        # string input
        (("61290370463", "61290370463"), [(61290370463, 61290370463)]),
    )
...
class rangeChunkBadInput(unittest.TestCase):
    def testLowBiggerThanHigh(self):
        ...
        self.assertRaises(
            DialplanException, ranges.split_range, 61290373598, 61290370463
        )
...
class patternChunks(unittest.TestCase):
    chunks = (
        ...
        (
            (61212349993, 61212350012),
            ["_6121234999[3-9]", "_6121235000X", "_6121235001[0-2]"],
        ),
        # small rollover with only high and low
        ((61212349993, 61212350002), ["_6121234999[3-9]", "_6121235000[0-2]"]),
        # small rollover with only middle and high ranges
        ((61212349990, 61212350002), ["_6121234999X", "_6121235000[0-2]"]),
        # tiny small range
        ((61290370463, 61290370469), ["_6129037046[3-9]"]),
        # equal start and end numbers
        ((61290370463, 61290370463), ["61290370463"]),
        # pattern for a Z
        ((61290370461, 61290370469), ["_6129037046Z"]),
        # pattern for a N
        ((61290370462, 61290370469), ["_6129037046N"]),
    )
