...
def common_start(first_number, last_number):
    """
    Get the common starting characters of the two strings first_number and
    last_number
    """
...
def test_block_for_coverage(patterns, first_number, last_number):
    """
    Helper function to allow testing for contiguous coverage of a block of numbers with
